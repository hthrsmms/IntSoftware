...
public class Orders {
	...
	public Orders(String orderNumber, String orderDate, String removeDate,
			String productNumber, int orderQuantity, String orderSupplier) {
	...
	public static String removalDate() { // one year from today - indicates when
											// to remove from order history
		ZoneId zonedId = ZoneId.of("America/Chicago");
		LocalDate today = LocalDate.now(zonedId);
