...
public class InventoryManager {
	...
	public static void main(String[] args) {
        ...
        Orders order1 = new Orders("555REX","05/01/2014","05/01/2015", "ABC100", 123, "Supplier1");
        Orders order2 = new Orders("55REX","2/28/2016", "2/28/2017","XYZ300", 12, "Supplier2");
        
        CurrentOrders.add(order1);
        CurrentOrders.add(order2);
   
/*      
        //to enter in new order from console, if needed
        ...
        String orderSupplier = input.nextLine();
        System.out.println("Please enter Order Quantity: ");
        int orderQuantity = input.nextInt(); 
        String orderDate = Orders.todaysDate();
        String removalDate = Orders.removalDate();
        
        Orders objt = new Orders(orderNumber, orderDate, removalDate, productNumber, orderQuantity, orderSupplier);
